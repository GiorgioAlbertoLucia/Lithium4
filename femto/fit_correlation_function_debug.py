...
def fitting_routine(outfile:TDirectory, bkg_input_path:str, data_input_path:str, h_data_name:str):
    ...
    h_bkg = load_hist(bkg_input_path, 'hHe3_p_Coul_CF')
    h_signal = load_hist('output/sampling.root', 'hKstar')
    h_correlation_function = load_hist('/home/galucia/Lithium4/preparation/output/correlation.root', 'CorrelationAntimatter/hCorrelation050')
