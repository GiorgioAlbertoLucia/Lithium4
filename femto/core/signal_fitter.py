...
class SignalFitter(Fitter):
    ...
    def init_signal(self, name:str='signal_pdf'):
        ...
        self._signal_pdf = RooCrystalBall(name, name, *self._signal_pars.values())

    def fit_signal(self, range_limits:tuple):
