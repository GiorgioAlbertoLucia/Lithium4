...
def draw_source_radius():
    ...
    for icentrality, centrality in enumerate(['0-10%', '10-30%', '30-50%']):
        ...
        x_pr = MEASURED_POINTS_MT['Pr'][centrality].n
        ...
        x_he = MEASURED_POINTS_MT['He'][centrality].n
    ...
    results_panel.Draw()
    legend.Draw('same')
    canvas.SaveAs('figures/source_radius_parameterisation_new.pdf')
    ...
    canvas_nch.SaveAs('figures/source_radius_parameterisation_nch_new.pdf')
