...
from core.purity_fitter import PurityFitter
...
class PurityAnalysis:
    ...
    def _get_pt_range(self, particle: str, sign: str):
        ...
        if particle == 'He3':
            tmp_pt_min, tmp_pt_max = PT_HE3
        else:
            tmp_pt_min, tmp_pt_max = PT_HAD
...
def main():
    ...
    # Configuration
    #input_file_path = '/data/galucia/lithium_local/purity/LHC24ar_pass1_small_purity_protons.root'
    #output_file_path = 'output/purity_24_pass1_p.root'
    input_file_path = '/data/galucia/lithium_local/purity/LHC23zzh_pass4_purity_protons.root'
    output_file_path = 'output/purity/purity_23_pass4_p.root'
    #input_file_path = '/data/galucia/lithium_local/purity/LHC23_PbPb_pass4_purity.root'
    #output_file_path = 'output/purity/purity_23_pass4_he3.root'
    ...
    tpc_config = {
        'He3': {
            ...
            'signal_window': (-4, 10.5),
            'fit_range': (-8, 8),
            'nsigma_integral': (-2, 2),
            'info_box_position': (0.65, 0.5, 0.85, 0.78)
        },
        'Had': {
            'signal_model': 'gausexp', #'gausdexp',
            'bkg_pt_min': [0., 0., 0., 0.],
    ...
    tof_config = {
        ...
        'Had': {
            ...
            'bkg_pt_min': [0., 1.6, 2.05],
            'bkg_pt_max': [1.6, 2.05, 5.,],
            'bkg_models': [
                        'exp',
                        'exp+exp',
                        'gausexp+exp'
    ...
    for particle in ['Had']:
        ...
        analysis.run(output_file, particle, 'TPC', tpc_config[particle])
        
        if particle == 'Had':
            analysis.run(output_file, particle, 'TOF', tof_config[particle])
