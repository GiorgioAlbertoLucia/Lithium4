//----------------------------------------------------------------------
//                 This is ctually AliPWGFunc from AliROOT
//                              ThermalModels
//
...
// variable you want to use calling ThermalModels::SetVarType with one of
...
class ThermalModels : public TObject {
...
private:
  ...
  ThermalModels(const ThermalModels&);            // not implemented
  ThermalModels& operator=(const ThermalModels&); // not implemented


  ClassDef(ThermalModels, 1)


};


ClassImp(ThermalModels)

ThermalModels::ThermalModels () : fLastFunc(0),  fLineWidth(1), fVarType(kdNdpt) {

  // ctor
  fLineWidth = 1;
}
ThermalModels::~ThermalModels(){
...
TF1 * ThermalModels::GetHistoFunc(TH1 * h, const char * name) {
...
TF1 * ThermalModels::GetGraphFunc(TGraph * g, const char * name) {
...
TF1 * ThermalModels::GetBGBW(Double_t mass, Double_t beta, Double_t T,
...
TF1 * ThermalModels::GetBoltzmann(Double_t mass, Double_t T, Double_t norm, const char * name){
  // Boltzmann
  switch (fVarType) {
  case kdNdpt:
...
TF1 * ThermalModels::GetTsallisBW(Double_t mass, Double_t beta, Double_t T, Double_t q,
...
TF1 * ThermalModels::GetMTExp(Double_t mass, Double_t T, Double_t norm, const char * name){
...
TF1 * ThermalModels::GetBoseEinstein(Double_t mass, Double_t T, Double_t norm, const char * name){
...
TF1 * ThermalModels::GetFermiDirac(Double_t mass, Double_t T, Double_t norm, const char * name){
...
TF1 * ThermalModels::GetPTExp(Double_t T, Double_t norm, const char * name){
...
TF1 * ThermalModels::GetLevi(Double_t mass, Double_t T, Double_t n, Double_t norm, const char * name){
  // Levi function (aka Tsallis)
  switch (fVarType) {
  case kdNdpt:
...
TF1 * ThermalModels::GetPowerLaw(Double_t pt0, Double_t n, Double_t norm, const char * name){
...
TF1 * ThermalModels::GetUA1(Double_t mass, Double_t p0star, Double_t pt0, Double_t n, Double_t T, Double_t norm, const char * name) {
...
Double_t ThermalModels::StaticHistoFunc(const double * x, const double* p){
...
//    double value = h->GetBinContent(bin);
  ...
  if(h->InheritsFrom("TH1")) {
    ...
    Printf("ThermalModels::StaticHistoFunc: Unsupported type");
    return 0;
  }
    //  }
...
Double_t ThermalModels::StaticUA1Func(const double * x, const double* p) {
  ...
  static ThermalModels * self = new ThermalModels;
  ...
  if (TMath::Abs(fPMTExp->Eval(p0star) - fPLaw->Eval(p0star)) > 0.0001 ) {
    Printf("ThermalModels::StaticUA1Func - Wrong norm") ; 
...
Double_t ThermalModels::StaticUA1FuncOneOverPt(const double * x, const double* p) {
  // UA1 func
...
Double_t ThermalModels::IntegrandBG(const double * x, const double* p){
...
Double_t ThermalModels::StaticBGdNdPt(const double * x, const double* p) {
...
Double_t ThermalModels::StaticBGdNdPtTimesPt(const double * x, const double* p) {
  // BGBW dNdpt implementation
  return x[0]*StaticBGdNdPt(x,p);
}

Double_t ThermalModels::StaticBGdNdMtTimesMt(const double * x, const double* p) {
  // BGBW dNdpt implementation
  // X0 is mt here
...
TF1 * ThermalModels::GetBGBWdNdpt(Double_t mass, Double_t beta, Double_t temp,
			      Double_t n, Double_t norm, const char * name){
...
Double_t ThermalModels::IntegrandTsallis(const double * x, const double* p){
...
Double_t ThermalModels::StaticTsallisdNdPt(const double * x, const double* p) {
...
Double_t ThermalModels::StaticTsallisdNdPtTimesPt(const double * x, const double* p) {
...
TF1 * ThermalModels::GetTsallisBWdNdpt(Double_t mass, Double_t beta, Double_t temp, Double_t q,
				   Double_t norm, Double_t ymax,const char * name){
...
// Times Pt funcs
// Boltzmann-Gibbs Blast Wave
TF1 * ThermalModels::GetBGBWdNdptTimesPt(Double_t mass, Double_t beta, Double_t temp, Double_t n,
...
// Boltzmann-Gibbs Blast Wave
TF1 * ThermalModels::GetBGBWdNdptTimesMt(Double_t mass, Double_t beta, Double_t temp, Double_t n,
				      Double_t norm, const char * name){
...
TF1 * ThermalModels::GetTsallisBWdNdptTimesPt(Double_t mass, Double_t beta, Double_t temp, Double_t q,
					  Double_t norm, Double_t ymax, const char * name){
...
TF1 * ThermalModels::GetMTExpdNdptTimesPt(Double_t mass, Double_t temp, Double_t norm, const char * name){
...
TF1 * ThermalModels::GetBoseEinsteindNdptTimesPt(Double_t mass, Double_t temp, Double_t norm, const char * name){
...
TF1 * ThermalModels::GetFermiDiracdNdptTimesPt(Double_t mass, Double_t temp, Double_t norm, const char * name){
...
TF1 * ThermalModels::GetPTExpdNdptTimesPt(Double_t temp, Double_t norm, const char * name){
...
TF1 * ThermalModels::GetBoltzmanndNdptTimesPt(Double_t mass, Double_t temp, Double_t norm, const char * name){
...
// Tsallis (no BW, a la CMS)
// TF1 * ThermalModels::GetTsallisdNdptTimesPt(Double_t mass, Double_t T, Double_t q, Double_t norm, const char * name){
...
TF1 * ThermalModels::GetLevidNdptTimesPt(Double_t mass, Double_t temp, Double_t n, Double_t norm, const char * name){
...
TF1 * ThermalModels::GetPowerLawdNdptTimesPt(Double_t pt0, Double_t n, Double_t norm, const char * name){
...
TF1 * ThermalModels::GetPowerLawdNdpt(Double_t pt0, Double_t n, Double_t norm, const char * name){
...
TF1 * ThermalModels::GetLevidNdpt(Double_t mass, Double_t temp, Double_t n, Double_t norm, const char * name){
...
TF1 * ThermalModels::GetLevidNdmt(Double_t mass, Double_t temp, Double_t n, Double_t norm, const char * name, VarType_t var){
...
// Test Function
Double_t ThermalModels::IntegrandTest(const double * x, const double* p){
...
Double_t ThermalModels::StaticTest(const double * x, const double* p) {
...
TF1 * ThermalModels::GetTestFunc(Double_t mass, Double_t temp, Double_t norm, Double_t ymax, const char * name){
...
TF1 * ThermalModels::GetMTExpdNdpt(Double_t mass, Double_t temp, Double_t norm, const char * name){
...
TF1 * ThermalModels::GetMTExpdNdmt(Double_t mass, Double_t temp, Double_t norm, const char * name, VarType_t var){
...
TF1 * ThermalModels::GetBoseEinsteindNdpt(Double_t mass, Double_t temp, Double_t norm, const char * name){
  // bose einstein
  char formula[500];
...
TF1 * ThermalModels::GetFermiDiracdNdpt(Double_t mass, Double_t temp, Double_t norm, const char * name){
  // bose einstein
  char formula[500];
  snprintf(formula,500,"[0]*1./(exp(sqrt(x**2+%f**2)/[1])+1)", mass);
  fLastFunc=new TF1(name,formula,0,10);
...
// TF1 * ThermalModels::GetTsallisdNdpt(Double_t mass, Double_t temp, Double_t q, Double_t norm, const char * name){
