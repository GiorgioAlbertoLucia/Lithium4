...
QA_HISTOGRAMS = {
    ...
    "hEta": RegistryEntry("hEtaHe", ";#eta;", "fEtaHe3", 100, -1, 1., condition='true', save_directory='QA'),
    "hPhi": RegistryEntry("hPhiHe", ";#phi (rad);", "fPhiHe3", 100, -3.14, 3.14, condition='true', save_directory='QA'),
