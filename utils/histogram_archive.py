...
QA_HISTOGRAMS = {
    ...
    "h2PtExpectedClusterSizeHe": RegistryEntry("h2PtExpectedClusterSizeHe", "^{3}He ;#it{p}_{T} (GeV/#it{c});Expected cluster size", "fSignedPtHe3", PT_NBINS, PT_MIN, PT_MAX, "fExpectedClusterSizeHe3", 90, 0, 15, 'true', 'QA'),
    ...
    "h2PtExpectedClusterSizePr": RegistryEntry("h2PtExpectedClusterSizePr", "p ;#it{p}_{T} (GeV/#it{c});Expected cluster size", "fSignedPtHad", PT_NBINS, PT_MIN, PT_MAX, "fExpectedClusterSizeHad", 90, 0, 15, 'true', 'QA'),
    ...
    "hEta": RegistryEntry("hEtaHe", "^{3}He ;#eta;", "fEtaHe3", 100, -1, 1., condition='true', save_directory='QA'),
    "hPhi": RegistryEntry("hPhiHe", "^{3}He ;#phi (rad);", "fPhiHe3", 100, -3.14, 3.14, condition='true', save_directory='QA'),
    ...
    "h2PtDCAxyHe3": RegistryEntry("h2PtDCAxyHe3", "^{3}He ;#it{p}_{T} (GeV/#it{c});DCA_{xy} (cm)", "fSignedPtHe3", PT_NBINS, PT_MIN, PT_MAX, "fDCAxyHe3", 100, -0.1, 0.1, 'true', 'QA'),
    "h2PtDCAzHe3": RegistryEntry("h2PtDCAzHe3", "^{3}He ;#it{p}_{T} (GeV/#it{c});DCA_{z} (cm)", "fSignedPtHe3", PT_NBINS, PT_MIN, PT_MAX, "fDCAzHe3", 100, -1.0, 1.0, 'true', 'QA'),
    "h2PtDCAxyHad": RegistryEntry("h2PtDCAxyHad", " p ;#it{p}_{T} (GeV/#it{c});DCA_{xy} (cm)", "fSignedPtHad", PT_NBINS, PT_MIN, PT_MAX, "fDCAxyHad", 100, -0.1, 0.1, 'true', 'QA'),
    "h2PtDCAzHad": RegistryEntry("h2PtDCAzHad", "p ;#it{p}_{T} (GeV/#it{c});DCA_{z} (cm)", "fSignedPtHad", PT_NBINS, PT_MIN, PT_MAX, "fDCAzHad", 100, -1.0, 1.0, 'true', 'QA'),
