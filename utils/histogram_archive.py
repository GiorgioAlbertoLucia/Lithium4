...
class Archive:
    QA_HISTOGRAMS = {
        ...
        "hPLiKstar": RegistryEntry("hPLiKstar", ";#it{p} (^{4}Li) (GeV/#it{c});#it{k}* (GeV/#it{c})", "fPLi", 100, 0, 10, "fKstar", 40, 0., 0.4, 'fCentralityFT0C < 50', 'QA'),
        "hPtHadKstar": RegistryEntry("hPtHadKstar", ";#it{p}_{T} (p) (GeV/#it{c});#it{k}* (GeV/#it{c})", "fSignedPtHad", 2000, -10, 10, "fKstar", 40, 0., 0.4, 'fCentralityFT0C < 50', 'QA'),
        "hPtHe3Kstar": RegistryEntry("hPtHe3Kstar", ";#it{p}_{T} (^{3}He) (GeV/#it{c});#it{k}* (GeV/#it{c})", "fSignedPtHe3", 2000, -10, 10, "fKstar", 40, 0., 0.4, 'fCentralityFT0C < 50', 'QA'),
